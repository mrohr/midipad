...
-(void) midiNotifyPropertyChange:(const MIDIObjectPropertyChangeNotification *)notification
{
    NSLog(@"%ld",notification->objectType);
...
- (void) midiNotify:(const MIDINotification*)notification
{
    switch (notification->messageID)
    {
        ...
        case kMIDIMsgPropertyChanged:
            [self midiNotifyPropertyChange:(const MIDIObjectPropertyChangeNotification *)notification];
            break;
